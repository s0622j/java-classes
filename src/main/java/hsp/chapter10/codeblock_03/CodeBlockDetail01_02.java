package hsp.chapter10.codeblock_03;

public class CodeBlockDetail01_02 {
...
//todo 1.static代码块是类加载时，执行，只会执行一次
//todo 2.普通代码块在创建对象时调用，创建一次调用一次，相当于构造器的扩展
//todo 3.类加载的三种情况，一、创建对象(new);二、创建子类对象，父类也会被加载;三、使用类的静态成员。