 ...
 * @author shenjie
 * @version 1.0.0
 * @ClassName RegExp03_04.java
 * @Description TODO 演示字符匹配符 的使用
 * @createTime 2022-04-26 11:21:00
 */
public class RegExp03_04 {

    public static void main(String[] args) {

        String content = "a11c8ab.caBcaBC _ABCy @";
        ...
        //String regStr = "\\d";//匹配 0-9的任意一个字符,同[0-9]
