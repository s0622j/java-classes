package hsp.chapter25_JDBC.jdbc_01.transaction_06;
 ...
 * @author shenjie
 * @version 1.0.0
 * @ClassName Transaction_01.java
 * @Description TODO 演示jdbc 中如何使用事务
 * @createTime 2022-04-23 20:08:00
 */
public class Transaction_01 {
    ...
    public void noTransaction() {
        ...
        try {
            connection = JDBCUtils_01.getConnection(); // 在默认情况下，connection是默认自动提交
