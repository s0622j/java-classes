 ...
 * @author shenjie
 * @version 1.0.0
 * @ClassName JDBCUtilsByDruid_USE_05.java
 * @Description TODO
 * @createTime 2022-04-24 13:09:00
 */
@SuppressWarnings({"all"})
public class JDBCUtilsByDruid_USE_05 {
    ...
    public void testSelect() {
        ...
        try {
            connection = JDBCUtilsByDruid_04.getConnection();
            ...
            //关闭资源
            JDBCUtilsByDruid_04.close(set, preparedStatement, connection);
        }
    }
