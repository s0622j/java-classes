 ...
 * @author shenjie
 * @version 1.0.0
 * @ClassName DBUtils_USE_06.java
 * @Description TODO
 * @createTime 2022-04-24 19:28:00
 */
@SuppressWarnings({"all"})
public class DBUtils_USE_06 {
    ...
    public void testQueryMany() throws SQLException { //返回结果是多行的情况
        ...
        //1. 得到 连接 (druid)
        Connection connection = JDBCUtilsByDruid_04.getConnection();
        ...
        //释放资源
        JDBCUtilsByDruid_04.close(null, null, connection);
