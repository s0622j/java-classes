package hsp.chapter25_JDBC.jdbc_01.batch_07;
 ...
 * @author shenjie
 * @version 1.0.0
 * @ClassName Batch_01.java
 * @Description TODO 演示java的批处理
 * @createTime 2022-04-23 20:28:00
 */
public class Batch_01 {
    ...
    //使用批量方式添加数据 注!!! properties文件的url必须要加上 url=jdbc:mysql://localhost:3306/hsp_db02?rewriteBatchedStatements=true
    @Test
