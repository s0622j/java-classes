 ...
 * @author shenjie
 * @version 1.0.0
 * @ClassName MethodRefTest01.java
 * @Description TODO
 * @createTime 2022-05-26 20:59:00
 */
public class MethodRefTest01 {
    ...
    @Test
    public void test2() {
        Employee emp = new Employee(1001,"tom",11,8200);

        Supplier<String> emp1 = () -> emp.getName();
        System.out.println(emp1.get());

        System.out.println("*******************");
        Supplier<String> emp2 = emp::getName;
    ...
    public void test3() {
        ...
        System.out.println(com2.compare(15,71));
    }
    ...
    public void test4() {
        ...
        System.out.println(func1.apply(12.1));
